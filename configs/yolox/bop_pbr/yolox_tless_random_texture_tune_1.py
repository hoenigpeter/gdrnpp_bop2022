...
dataloader.train.aug_wrapper.COLOR_AUG_CODE = (
    "Sequential(["
    #"Sometimes(0.5, CoarseDropout( p=0.2, size_percent=0.05) ),"    # cuts out rectangles, good to simulate occlusion, we should keep that
...
dataloader.train.aug_wrapper.AUG_HSV_PROB = 0
dataloader.train.aug_wrapper.HSV_H = 0
dataloader.train.aug_wrapper.HSV_S = 0
dataloader.train.aug_wrapper.HSV_V = 0
dataloader.train.aug_wrapper.FORMAT = "RGB"
