...
OUTPUT_DIR = "output/gdrn/ycbv_ichores"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("ycb_ichores_train_pbr",),
    #TEST=("ycb_ichores_test",),
    DET_FILES_TEST=("datasets/BOP_DATASETS/ycb_ichores/test/test_bboxes/scene_gt_dummy_bb.json",),
)
