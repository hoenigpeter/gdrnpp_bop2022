...
class KEYPOSE_PBR_Dataset:
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get("dataset_root", osp.join(DATASETS_ROOT, "BOP_DATASETS/keypose_random_texture/train_pbr"))
        ...
        self.cat_ids = [cat_id for cat_id, obj_name in ref.keypose_random_texture.id2obj.items() if obj_name in self.objs]
    ...
    def models(self):
        ...
        for obj_name in self.objs:
            model = inout.load_ply(
                osp.join(self.models_root, f"obj_{ref.keypose_random_texture.obj2id[obj_name]:06d}.ply"),
...
SPLITS_KEYPOSE_PBR = dict(
    keypose_random_texture_train_pbr=dict(
        name="keypose_random_texture_train_pbr",
        objs=ref.keypose_random_texture.objects,  # selected objects
